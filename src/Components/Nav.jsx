    ...
    <nav>
      ...
      <div className="nav-2 nav-item">
        <div className="col">
          <a
            target="_blank"
            href="https://www.linkedin.com/in/manish-dhaka-b01b1828b"
          >
            linkedin
          </a>
          <a target="_blank" href="https://x.com/dev_manish93">
            X (twitter)
          </a>
        ...
        <div className="col">
          <a
            target="_blank"
            href="https://www.instagram.com/dev_manish_js?igsh=dm16azE4OTY1MGVy"
          >
            instagram
          </a>
    ...
    <nav>
      <div ref={NavItemsRef} style={{ display: "none" }} className="nav-items">
        <div className="head">
          <h1>Menu</h1>
          <p
            onClick={(e) => setIsMobileNavOpen(!IsMobileNavOpen)}
            className="close-btn"
          >
            Close
          </p>
          ...
          <div className="items">
            <div className="links">
              <div className="link">
                ...
                <h1>01</h1>
                <div className="link-text">Dev Manish</div>
              </div>
              ...
              >
                <div className="link">
                  <div className="line"></div>
                  <h1>04</h1>
                  <div className="link-text">linked in</div>
                </div>
              </a>
              <a target="_blank" href="https://x.com/dev_manish93">
                <div className="link">
                  <div className="line"></div>
                  <h1>05</h1>
                  <div className="link-text">X (twitter)</div>
                </div>
              </a>
              <a
                target="_blank"
